...
if __name__ == "__main__":
    ...
    test_qr1, un1 = nmf_pyr.py_calculate_q_robust(V, U, sa.W, sa.H, 4.0)
    ...
    # _V = copy.copy(V)
    # _U = copy.copy(U)
    sa2 = SA(factors=n_components, V=V, U=U, seed=seed, method=method, optimized=True)
    sa2.initialize()
    sa2.train(max_iter=50, converge_delta=0.01, converge_n=10)
    H2b = sa2.H
    W2b = sa2.W
