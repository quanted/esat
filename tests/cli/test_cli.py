...
def test_setup():
    logger.info("Running CLI Test Setup")
    runner = CliRunner()
...
def test_run():
    logger.info("Running CLI Test Run")
...
def test_setup_sim():
    logger.info("Running CLI SIM Setup")
    runner = CliRunner()
...
def test_gen_sim():
    logger.info("Running CLI SIM Gen")
    runner = CliRunner()
...
def test_run_sim():
    logger.info("Running CLI SIM Run")
    run_config_file = os.path.join(project_directory, "run_config.toml")
...
def test_setup_error():
    logger.info("Running CLI Error Setup")
    runner = CliRunner()
...
def test_run_error_fail():
    logger.info("Running CLI Error Run")
    runner = CliRunner()
...
#     logger.info("Running CLI Error Disp")
#     run_config_file = os.path.join(project_directory, "run_config.toml")
...
#     logger.info("Running CLI BS Error Run")
#     run_config_file = os.path.join(project_directory, "run_config.toml")
#     error_config_file = os.path.join(project_directory, "error_config.toml")
#     input_file = os.path.join(data_path, "Dataset-BatonRouge-con.csv")
#     uncertainty_file = os.path.join(data_path, "Dataset-BatonRouge-unc.csv")
...
#     logger.info("Running CLI BS Disp Error Run")
#     run_config_file = os.path.join(project_directory, "run_config.toml")
#     error_config_file = os.path.join(project_directory, "error_config.toml")
#     input_file = os.path.join(data_path, "Dataset-BatonRouge-con.csv")
#     uncertainty_file = os.path.join(data_path, "Dataset-BatonRouge-unc.csv")
...
#     logger.info("Running CLI Constrained Setup")
#     runner = CliRunner()
...
#     logger.info("Running CLI Constrained Run")
#     run_config_file = os.path.join(project_directory, "run_config.toml")
#     run_config = configparser.ConfigParser()
#     run_config.read(run_config_file)
#
